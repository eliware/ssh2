  ...
  class KeyExchange {
    ...
    finish(scOnly) {
      ...
      if (!isServer) {
        ...
        const expectedSigType = negotiated.serverHostKey.endsWith('-cert-v01@openssh.com')
          ? negotiated.serverHostKey.replace('-cert-v01@openssh.com', '')
          : negotiated.serverHostKey;
        if (sigType !== negotiated.serverHostKey && sigType !== expectedSigType) {
          return doFatalError(
            this._protocol,
